...
To manage the sampling of the population and the compounding growth of subsequent analysis decisions, we used the targets v.1.6.0 and tarchetypes v.0.8.0 R packages (\citeproc{ref-targets}{Landau, 2021a},\citeproc{ref-tarchetypes}{b}).
...
We used the \emph{ctmm} v.1.1.1 (\citeproc{ref-ctmm}{Fleming \& Calabrese, 2023}) package for the creation of AKDEs, and the \emph{adehabitatHR} v.0.4.21 (\citeproc{ref-adehabitatHR}{Calenge \& Scott Fortmann-Roe, 2023}) package for the MCPs.
...
We ran individual step selection models using the amt v.0.2.1.0 (\citeproc{ref-amt}{Signer, Fieberg \& Avgar, 2019}) package, to explore rudimentary summary methods.
...
We followed the code provided by Muff, Signer \& Fieberg (\citeproc{ref-muff_accounting_2020}{2020}) and made use of \emph{INLA} v.23.9.9 (\citeproc{ref-rue_approximate_2009}{Rue, Martino \& Chopin, 2009}; \citeproc{ref-lindgren_explicit_2011}{Lindgren, Rue \& Lindström, 2011}; \citeproc{ref-martins_bayesian_2013}{Martins et al., 2013}; \citeproc{ref-rue_bayesian_2017}{Rue et al., 2017}; \citeproc{ref-kourounis_towards_2018}{Kourounis, Fuchs \& Schenk, 2018}) to run Poisson models to estimate habitat selection.
...
We ran the Bayesian Regression Models using the \emph{brms} v.2.19.0 (\citeproc{ref-brms}{Bürkner, 2021}) package.
...
We used \emph{R} v.4.3.3 (\citeproc{ref-base}{R Core Team, 2023}) via \emph{RStudio} v.2023.09.1 (\citeproc{ref-rstudio}{RStudio Team, 2022}).
...
We used \emph{raster} v.3.6.20 (\citeproc{ref-raster}{Hijmans, 2023}) and \emph{RandomFields} v.3.3.14 (\citeproc{ref-RandomFields}{Schlather et al., 2015}) to aid landscape raster creation alongside NLMR v.1.1.1 (\citeproc{ref-NLMR}{Sciaini et al., 2018}).

We used \emph{ggplot2} v.3.4.2 for creating figures (\citeproc{ref-ggplot2}{Wickham, 2016}), with the expansions: \emph{patchwork} v.1.1.2 (\citeproc{ref-patchwork}{Pedersen, 2022}), \emph{ggridges} v.0.5.4 (\citeproc{ref-ggridges}{Wilke, 2022}), \emph{ggdist} v.3.3.0 (\citeproc{ref-ggdist}{Kay, 2023a}), and \emph{ggtext} v.0.1.2 (\citeproc{ref-ggtext}{Wilke \& Wiernik, 2022}).

We used \emph{brms} v.2.19.0 (\citeproc{ref-brms}{Bürkner, 2021}) to run Bayesian models, with diagnostics generated used \emph{bayesplot} v.1.10.0 (\citeproc{ref-bayesplot}{Gabry et al., 2019}), \emph{tidybayes} v.3.0.4 (\citeproc{ref-tidybayes}{Kay, 2023b}), and \emph{performance} v.0.10.3 (\citeproc{ref-performance}{Lüdecke et al., 2021}).

We used the \emph{dplyr} v.1.1.2 (\citeproc{ref-dplyr}{Wickham et al., 2023}), \emph{tibble} v.3.2.1 (\citeproc{ref-tibble}{Müller \& Wickham, 2023}),
and \emph{stringr} v.1.5.0 (\citeproc{ref-stringr}{Wickham, 2022}) packages for data manipulation.

We used \emph{sp} v.1.6.0 (\citeproc{ref-sp}{Bivand, Pebesma \& Gomez-Rubio, 2013}), \emph{move} v.4.1.12 (\citeproc{ref-move}{Kranstauber, Smolla \& Scharf, 2023}) for manipulation of spatial data and estimation of space use not otherwise mentioned in the methods.

We used rmarkdown v.2.21 (\citeproc{ref-rmarkdown2018}{Xie, Allaire \& Grolemund, 2018}; \citeproc{ref-rmarkdown2020}{Xie, Dervieux \& Riederer, 2020}; \citeproc{ref-rmarkdown2023}{Allaire et al., 2023}), bookdown v.0.34 (\citeproc{ref-bookdown2016}{Xie, 2016}, \citeproc{ref-R-bookdown}{2022}), tinytex v.0.45 (\citeproc{ref-tinytex2019}{Xie, 2019}, \citeproc{ref-tinytex2023}{2023a}), and knitr v.1.42 (\citeproc{ref-knitr2014}{Xie, 2014}, \citeproc{ref-knitr2015}{2015}, \citeproc{ref-knitr2023}{2023b}) packages to generate type-set outputs.
