...
```{r loadModelExtracts, echo=FALSE, message=FALSE, warning=FALSE}
...
The sample size was negatively correlated with deviation from the median estimate ($\beta$ `r round(betasOutputs[betasOutputs$model == "ssfBrms" & betasOutputs$.variable == "b_sampleSizeScaled",]$.value, digits = 2)`; 95% HDCI `r paste(round(c(betasOutputs[betasOutputs$model == "ssfBrms" & betasOutputs$.variable == "b_sampleSizeScaled",]$.lower, betasOutputs[betasOutputs$model == "ssfBrms" & betasOutputs$.variable == "b_sampleSizeScaled",]$.upper), digits = 2), collapse = " - ")`).
