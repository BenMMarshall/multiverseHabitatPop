...
Prominent replication studies have shown that previously "text-book" examples in multiple disciplines may need further study [CITE OTHERS HERE; @sanchez-tojar_meta-analysis_2018].
While other disciplines' replication rates have been more closely examined (see @kelly_rate_2019 for ecological replication rates), there is evidence that biology, ecology and evolution studies require similar scrutiny with regards to reliable as many of the same incentive structures seen as responsible exist [@Brembs2018; @fanelli_pressures_2010; @smaldino_natural_2016; @ware_significance_2015].
...
In broader terms, undertaking studies that subject and method differ from the original sutdy, the where the research questions are conceptually similar [@kelly_rate_2019; @nakagawa_replicating_2015].
