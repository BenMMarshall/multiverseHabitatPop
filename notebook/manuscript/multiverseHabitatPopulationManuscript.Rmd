...
Here we see the benefits of including the step and turn angles in the model formula for the summarised SSF approach ($beta$ `r beta_ssfBrms_b_modelFormulamf.ss`), but a contrasting effect for both the Two-step ($beta$ `r beta_twoStepBrms_b_modelFormulamf.ss`) and Poisson approaches ($beta$ `r beta_poisBrms_b_modelFormulamf.ss`) where the not integrated formula tends to reduce the spread of estimates (Fig. \@ref(fig:effectPlotSSF).
